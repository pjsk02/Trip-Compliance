import type { CategoryCoverage } from '../types';

const CATEGORIES: { key: keyof CategoryCoverage; label: string; icon: string }[] = [
...
export function CategoryProgress({ coverage }: { coverage: CategoryCoverage }) {
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        <p className="text-xs text-gray-400">{doneCount}/4 covered</p>
      </div>
